...
//                    NavigationLink {
//                        Text("SwiftDataItem at \(item.timestamp, format: Date.FormatStyle(date: .numeric, time: .standard))")
//                    } label: {
...
//                        Label("Add SwiftDataItem", systemImage: "plus")
//                    }
//                }
//            }
//        } detail: {
...
//        withAnimation {
//            let newItem = SwiftDataItem(timestamp: Date())
